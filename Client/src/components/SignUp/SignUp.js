...
//           <div className='user'>
//             <input type='radio' name='usertype' id='user' value={'author'}{...register('userType',{required:true})}/>
//             <lable className='userlable' for='author'>Author</lable>
//           </div>
//           <div className='user'>
//             <input type='radio' name='usertype' id='user' value={'user'} {...register('userType',{required:true})} />
//             <lable className='userlable' for='user'>User</lable>
//           </div>
//         </div>
//         {
...
//         </div>
//         <div className='inputs'>
//           <label for="password" className='inputlabel'>Username</label>
...
//           <input type="text" name="email" id="email" placeholder='Enter email' {...register("email", {pattern: {value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i,message: 'enter proper email' }})}/>
//           {
